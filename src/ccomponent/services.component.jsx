  ...
  return (
    <div className="md:grid md:grid-cols-2 md:gap-3">
      <div className=" mx-auto ">
        <h2 className=" font-bold text-[#A1B57D] text-2xl text-center py-3">
          Background
        </h2>
        <p className="dark:text-white py-2 text-center text-gray-600">
          I recently graduated from{" "}
          <span className="text-black dark:text-gray-600 font-bold">
            Lagos City Polytechnic
          </span>{" "}
          after completing my degree in Accounting.
        </p>
        <p className="dark:text-white py-2 text-center text-gray-600">
          As a web developer, I enjoy bridging the gap between Acccounting,
          design and web app - combining my technical knowledge with my keen eye
          ...
          providing engaging, pixel-perfect user experience.
        </p>
        <p className="dark:text-white py-2 text-center text-gray-600">
          <span className="text-black dark:text-gray-600 font-bold">
            When I'm not in front of a computer screen.
          </span>{" "}
          I'm Probably reading books, drawing or playing games.
        </p>
